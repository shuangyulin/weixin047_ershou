  ...
  methods: {
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                                                                                                                              ...
                                                                                                                                                                              if((!this.ruleForm.maijiashouji)&& 'maijia'==this.flag){
        this.$message.error('卖家手机不能为空');
        return
      }
        ...
        return
                                    ...
                                    if((!this.ruleForm.shenfenzheng)&& 'maijia'==this.flag){
        ...
        return
                                                                                          ...
                                                                                          if( 'maijia' ==this.flag && this.ruleForm.thumbsupnum&&(!isIntNumer(this.ruleForm.thumbsupnum))){
       this.$message.error(`赞应输入整数`);
        return
      }
                                                                  if( 'maijia' ==this.flag && this.ruleForm.crazilynum&&(!isIntNumer(this.ruleForm.crazilynum))){
       this.$message.error(`踩应输入整数`);
        return
      }
                                                                                                                        if( 'maijia' ==this.flag && this.ruleForm.clicknum&&(!isIntNumer(this.ruleForm.clicknum))){
